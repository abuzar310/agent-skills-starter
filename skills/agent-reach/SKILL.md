...
Official skill from [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) (MIT).
This folder is the **router skill only**. Do not clone the Agent Reach repo into a
project workspace. Cookies, logins, and tokens stay with the user — never paste
or commit them. Optional CLI install is user-driven (`pip install agent-reach`);
this pack does not run their installer or read browser cookies.
